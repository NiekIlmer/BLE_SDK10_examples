...
#define NOTIF_TASK_AQUISITION_DONE      (1 << 1)
#define NOTIF_TASK_AQUISITION_STOP      (1 << 2)
...
#define DEMO_CHANNEL_DATA_BUF_BASIC_SIZE (25600U)
#define RECORDING_DURATION_MSEC (100)
#define DEMO_CHANNEL_DATA_BUF_TOTAL_SIZE (DEMO_CHANNEL_DATA_BUF_BASIC_SIZE * RECORDING_DURATION_MSEC * 16 / 1000U)
#define DEMO_CHANNEL_DATA_BUF_CB_SIZE    (RECORDING_SAMPLE_RATE / 100 * 2 * 2 * 2) //callback every 20ms

/* PDM Interface */
#define PDM_CLK_PORT     HW_GPIO_PORT_1
#define PDM_CLK_PIN      HW_GPIO_PIN_2

#define PDM_DATA_PORT    HW_GPIO_PORT_1
#define PDM_DATA_PIN     HW_GPIO_PIN_3

#define PDM_MIC_PE_PORT  HW_GPIO_PORT_1
#define PDM_MIC_PE_PIN   HW_GPIO_PIN_4
...
typedef struct {
        ...
        uint16_t * buff_l; //left channel buffer address
        uint16_t * buff_r; //right channel buffer address
