                                         ...
                                         const int32_t activation_max)
{
    ...
    for (int32_t i = 0; i < row_loop_cnt; i++)
    {
        ...
        for (int j = col_loop_cnt; j != 0; j--)
        {
            ...
            int32_t vec_1 = __SXTAB16(__ROR(lhs_offset_s16x2, (uint32_t)vec_0, 8));
            vec_0 = __SXTAB16(lhs_offset_s16x2, vec_0);
            int32_t ker_0 = arm_nn_read_q7x4_ia(&rhs_0);
            int32_t ker_1 = __SXTAB16(__ROR(rhs_offset_s16x2, (uint32_t)ker_0, 8));
            ...
            ker_1 = __SXTAB16(__ROR(rhs_offset_s16x2, (uint32_t)ker_0, 8));
            ker_0 = __SXTAB16(rhs_offset_s16x2, ker_0);
